...
{'model':'WongLinf','attack':'PFPMA','p_norm':'L2','outloop_num':3,'innerloop_num':150,'stepsize':0.01,'penalty_type':'MaxSquare','batch_size':batch_size,'beta':0.0,'UseRMS':True,'rho':0.99,'lam':10,'decay':0.3},
{'model':'WangL2WRN-28-10','attack':'PFPMA','p_norm':'L2','outloop_num':3,'innerloop_num':150,'stepsize':0.01,'penalty_type':'Max','batch_size':batch_size,'beta':0.0,'UseRMS':True,'rho':0.99,'lam':10,'decay':0.3},
{'model':'WangL2WRN-28-10','attack':'PFPMA','p_norm':'L2','outloop_num':3,'innerloop_num':150,'stepsize':0.01,'penalty_type':'MaxSquare','batch_size':batch_size,'beta':0.0,'UseRMS':True,'rho':0.99,'lam':10,'decay':0.3},
...
{'model':'Standard','attack':'PFPMA','p_norm':'L1','outloop_num':3,'innerloop_num':150,'stepsize':0.001,'penalty_type':'MaxSquare','batch_size':batch_size,'beta':0.0,'UseRMS':True,'rho':0.999,'lam':0.1,'decay':0.3},
...
{'model':'WongLinf','attack':'PFPMA','p_norm':'L1','outloop_num':3,'innerloop_num':150,'stepsize':0.01,'penalty_type':'MaxSquare','batch_size':batch_size,'beta':0.0,'UseRMS':True,'rho':0.999,'lam':1,'decay':0.3},
{'model':'WangL2WRN-28-10','attack':'PFPMA','p_norm':'L1','outloop_num':3,'innerloop_num':150,'stepsize':0.01,'penalty_type':'Max','batch_size':batch_size,'beta':0.0,'UseRMS':True,'rho':0.999,'lam':1,'decay':0.3},
{'model':'WangL2WRN-28-10','attack':'PFPMA','p_norm':'L1','outloop_num':3,'innerloop_num':150,'stepsize':0.01,'penalty_type':'MaxSquare','batch_size':batch_size,'beta':0.0,'UseRMS':True,'rho':0.999,'lam':1,'decay':0.3},
...
{'model': 'WangL2WRN-28-10','attack':'DDN','batch_size':batch_size ,'iter_num':1000},
...
{'model': 'WangL2WRN-28-10','attack':'EAD','batch_size':batch_size ,'iter_num':1000},
...
{'model':'WangL2WRN-28-10','attack':'CW','iter_max':10000,'lr': 0.001,'batch_size':batch_size,'c':10},
{'model':'WongLinf','attack':'CW','iter_max':10000,'lr': 0.001,'batch_size':batch_size,'c':10},

{'model':'Standard','attack':'DeepFool','iter_max':3000,'batch_size':batch_size},
{'model':'WangL2WRN-28-10','attack':'DeepFool','iter_max':3000,'batch_size':batch_size},
{'model':'WongLinf','attack':'DeepFool','iter_max':3000,'batch_size':batch_size},
...
{'model':'WangL2WRN-28-10','attack':'FAB_advlib','p_norm':1,'steps':200,'batch_size':batch_size},
    ]
...
for item in list_para:
    ...
    if item['attack'] == 'PFPMA':
        for i in range(0,len(correct_index),item['batch_size']):
            ...
            if item['p_norm']=='L2':
               ...
               #adv_images=PFPMA_L1_FISTA(model,images, labels,outloop_num=item['outloop_num'],innerloop_num=item['innerloop_num'],StepSize=item['stepsize'],penalty_type=item['penalty_type'],beta=item['beta'],UseRMS=item['UseRMS'],rho=item['rho'],lam=item['lam'],decay=item['decay'])
               #adv_images=PFPMA_L1_prox(model,images, labels,outloop_num=item['outloop_num'],innerloop_num=item['innerloop_num'],StepSize=item['stepsize'],penalty_type=item['penalty_type'],beta=item['beta'],UseRMS=item['UseRMS'],rho=item['rho'])
    ...
    if 'PFPMA' == item['attack']:
        torch.save(dict_save,'./result/cifar10-first1000/{}_attack_{}_pnorm{}_PenalyType{}_lam{}_decay{}_stepsize{}_beta{}_UseRMS{}_rho{}.pt'.format(item['model'],item['attack'],item['p_norm'],item['penalty_type'],item['lam'],item['decay'],item['stepsize'],item['beta'],item['UseRMS'],item['rho']))
